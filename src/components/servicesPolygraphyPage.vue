        ...
        &-services {
            ...
            .bg-pic {
                ...
                &:nth-child(1) {
                    width: 530px;
                    height: 520px;
                    background: url("/img/pol-bgpic-1.png") no-repeat center;
                ...
                &:nth-child(2) {
                    width: 420px;
                    height: 530px;
                    background: url("/img/pol-bgpic-2.png") no-repeat center;
                    background-size: cover;
                    transform: rotate(15deg);
                    right: 20px;
                    top: 40px;
                ...
                &:nth-child(3) {
                    width: 250px;
                    height: 320px;
                    background: url("/img/pol-bgpic-3.png") no-repeat center;
                    background-size: cover;
