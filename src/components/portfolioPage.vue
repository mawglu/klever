<template>
    <div class="bg-black h-vh-100 w-vw-100" @wheel="onwheel" ref="topTrigger">
                    ...
                    <div class="portfolio-slider">
                        <div class="slide">
                            ...
                            <div class="back">
                                ...
                                <div class="mt-auto mb-5 ml-auto">
                                    <b-button variant="my" @click="showModal('portfolio-1')">
                        ...
                        <div class="slide">
                            ...
                            <div class="back">
                                ...
                                <div class="mt-auto mb-5 ml-auto">
                                    <b-button variant="my" @click="showModal('portfolio-2')">
                                        <div class="circle circle-80 circle-transparent circle-gray-br">
                                            <svg width="21" height="16" class="m-auto" viewBox="0 0 21 16"
                                                 fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="slide">
                            ...
                            <div class="back">
                                ...
                                <div class="mt-auto mb-5 ml-auto">
                                    <b-button variant="my" @click="showModal('portfolio-3')">
                                        <div class="circle circle-80 circle-transparent circle-gray-br">
                                            <svg width="21" height="16" class="m-auto" viewBox="0 0 21 16"
                                                 fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="slide">
                            ...
                            <div class="back">
                                ...
                                <div class="mt-auto mb-5 ml-auto">
                                    <b-button variant="my" @click="showModal('portfolio-4')">
                                        <div class="circle circle-80 circle-transparent circle-gray-br">
                                            <svg width="21" height="16" class="m-auto" viewBox="0 0 21 16"
                                                 fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
        ...
        <b-modal id="portfolio-1" size="xl" hide-header hide-footer
                 modal-class="portfolio-modal"
        >
            <b-button @click="hideModal('portfolio-1')" variant="modal">
        ...
        <b-modal id="portfolio-2" size="xl" hide-header hide-footer
                 modal-class="portfolio-modal"
        >
            <b-button variant="modal" @click="hideModal('portfolio-2')">
                <div class="circle circle-80 circle-transparent circle-white-br d-flex">
                    <svg class="m-auto" width="17" height="16" viewBox="0 0 17 16"
                         fill="none"
                         xmlns="http://www.w3.org/2000/svg">
        ...
        <b-modal id="portfolio-3" size="xl" hide-header hide-footer
                 modal-class="portfolio-modal"
        >
            <b-button @click="hideModal('portfolio-3')" variant="modal">
                <div class="circle circle-80 circle-transparent circle-white-br d-flex">
                    <svg class="m-auto" width="17" height="16" viewBox="0 0 17 16"
                         fill="none"
                         xmlns="http://www.w3.org/2000/svg">
        ...
        <b-modal id="portfolio-4" size="xl" hide-header hide-footer
                 modal-class="portfolio-modal"
        >
            <b-button @click="hideModal('portfolio-4')" variant="modal">
                <div class="circle circle-80 circle-transparent circle-white-br d-flex">
                    <svg class="m-auto" width="17" height="16" viewBox="0 0 17 16"
                         fill="none"
                         xmlns="http://www.w3.org/2000/svg">
        ...
        methods: {
            onwheel(ev) {
                if (this.windowWidth <= this.mobileSizeBreakpoint) {
                    ...
                    if (typeof this.$refs.topTrigger !== 'undefined') {
                        if (ev.deltaY < 0 && this.$refs.topTrigger.getBoundingClientRect().top >= 0) {

                            this.$root.$emit('change-animation-direction', {
                                direction: 'top',
                            });

                            if (this.$route.name !== 'main-portfolio') {
